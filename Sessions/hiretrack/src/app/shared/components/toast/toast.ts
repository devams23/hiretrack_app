  ...
  template: `
    <div class="fixed top-4 right-4 z-50 flex flex-col gap-2">
      @for (toast of toastService.toasts(); track toast.id) {
        <div 
          class="px-4 py-3 rounded-md shadow flex items-center gap-3 transition-auto duration-300"
        ...
        >
          ...
          <button (click)="toastService.remove(toast.id)" class="ml-auto text-gray-400 hover:text-gray-900 focus:outline-none">
